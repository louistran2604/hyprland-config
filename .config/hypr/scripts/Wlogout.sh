...
if ((resolution >= 2160)); then
    ...
    wlogout --protocol layer-shell -b 6 -T $T_val -B $B_val -l ~/.config/wlogout/layout -s ~/.config/wlogout/style.css &
    ...
    wlogout --protocol layer-shell -b 6 -T $T_val -B $B_val -l ~/.config/wlogout/layout -s ~/.config/wlogout/style.css &else
