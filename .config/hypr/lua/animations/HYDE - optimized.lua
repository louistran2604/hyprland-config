...
hl.curve("menu_decel", { type = "bezier", points = { {0.05, 0.82}, {0.0, 1.0} } })
hl.curve("menu_accel", { type = "bezier", points = { {0.2, 0.0}, {0.82, 0.1} } })
hl.curve("easeInOutCirc", { type = "bezier", points = { {0.75, 0.0}, {0.15, 1.0} } })
hl.curve("easeOutCirc", { type = "bezier", points = { {0.0, 0.48}, {0.38, 1.0} } })
hl.curve("easeOutExpo", { type = "bezier", points = { {0.1, 0.94}, {0.23, 0.98} } })
hl.curve("softAcDecel", { type = "bezier", points = { {0.2, 0.2}, {0.15, 1.0} } })
hl.curve("md2", { type = "bezier", points = { {0.3, 0.0}, {0.15, 1.0} } })
hl.curve("OutBack", { type = "bezier", points = { {0.28, 1.4}, {0.58, 1.0} } })
hl.curve("easeInOutCirc", { type = "bezier", points = { {0.78, 0.0}, {0.15, 1.0} } })
